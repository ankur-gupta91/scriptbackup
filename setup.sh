...
sudo wget http://openvswitch.org/releases/openvswitch-2.4.0.tar.gz
sudo tar zxvf openvswitch-2.4.0.tar.gz
cd openvswitch-2.4.0
sudo apt-get -y install dh-autoreconf libssl-dev openssl build-essential fakeroot graphviz python-all python-qt4 python-twisted-conch debhelper autoconf automake automake1.10 libtool
