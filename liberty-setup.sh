...
git clone http://git.openstack.org/openstack-dev/devstack -b stable/liberty /home/vagrant/devstack
git clone http://github.com/openstack/networking-odl -b stable/liberty /opt/stack/networking-odl
